...
function GameItem:setupNodes()
	...
	if device.platform == "mac" then
		...
		-- local texture_a = cc.Director:getInstance():getTextureCache():addImage("res/sightlight/foreground.png")

		-- self.berlin_a = my.QBerlinSprite:create()
		-- 				:hide()
		-- 				:addTo(self)

		-- self.berlin_a:setSpriteFrame(ImageUtil:frameForFile("res/image/61.png"))

		-- self.berlin_a:setShaders("res/shader/noise.vsh","res/shader/noise.fsh")

		-- self.berlin_a:setNoiseTexture(ImageUtil:textureForFile("res/shader/noise.png"))



		-- self.berlin_b = my.QBerlinSprite:create()
		-- 				:hide()
		-- 				:addTo(self)

		-- self.berlin_b:setSpriteFrame(ImageUtil:frameForFile("res/image/62.png"))

		-- self.berlin_b:setShaders("res/shader/noise.vsh","res/shader/noise.fsh")

		-- self.berlin_b:setNoiseTexture(ImageUtil:textureForFile("res/shader/noise.png"))
		...
		local function tick(dt)
			...
			if tick_count >= 3.141592653 * 10 then
				tick_count = 0.0
			end
