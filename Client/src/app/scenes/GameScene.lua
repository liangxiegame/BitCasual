...
function GameScene:ctor()
    ...
    if not DataManager.GameMusicOn then 
        audio.playMusic("sound/PlayTheBeat.mp3", true)
        DataManager.GameMusicOn = true
...
function GameScene:setupNodes()
    ...
    display.newSprite("image/line.png", display.cx, ITEM_DISTANCE * 6 + 40)
        :addTo(self)
